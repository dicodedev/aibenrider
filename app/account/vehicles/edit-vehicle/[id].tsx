...
export default function EditVehicle() {
  ...
  const fetchVehicles = async () => {
    ...
    const index = categories.findIndex((i) => i.id == res.data.category_id);
            ...
            >
              ...
              >
                <Svg width="8" height="13" viewBox="0 0 8 13" fill="none">
                  <Path
                    d="M7.13395 11.91L6.07295 12.97L0.29395 7.193C0.200795 7.10043 0.126867 6.99036 0.0764187 6.86911C0.0259707 6.74786 -5.78549e-07 6.61783 -5.67068e-07 6.4865C-5.55587e-07 6.35517 0.0259708 6.22514 0.0764187 6.10389C0.126867 5.98264 0.200795 5.87257 0.29395 5.78L6.07295 5.30914e-07L7.13295 1.06L1.70895 6.485L7.13395 11.91Z"
                    fill="black"
                  />
                </Svg>
              </Pressable>
              ...
              >
                <Svg width="8" height="13" viewBox="0 0 8 13" fill="none">
                  <Path
                    d="M-0.000161171 1.06L1.06084 1.90735e-06L6.83984 5.777C6.93299 5.86957 7.00692 5.97965 7.05737 6.1009C7.10782 6.22215 7.13379 6.35218 7.13379 6.4835C7.13379 6.61483 7.10782 6.74486 7.05737 6.86611C7.00692 6.98736 6.93299 7.09743 6.83984 7.19L1.06084 12.97L0.000838757 11.91L5.42484 6.485L-0.000161171 1.06Z"
                    fill="black"
                  />
                </Svg>
              </Pressable>
            ...
            <View style={{}}>
              ...
              >
                ...
                <View style={styles.container}>
                  ...
                  />
                  {errors.year && <InputError message={errors.year.message} />}
                </View>
...
const RemoveModal = ({ setVisible, setImages, data }) => {
